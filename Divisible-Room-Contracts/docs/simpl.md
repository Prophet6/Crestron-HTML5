# SIMPL pairing — Divisible-Room-Contracts

Same S+ modules as [Divisible-Room](../../Divisible-Room/docs/simpl.md). The HTML5 XPanel uses the **GUI extender** from [`contracts/divisible-room.chd`](../contracts/divisible-room.chd) instead of numbered joins.

## Attach the contract

1. Add an HTML5 XPanel (E1 / E2 / E3 / master).
2. **Project → Manage GUI Extenders** → browse to `Divisible-Room-Contracts/contracts/divisible-room.chd` → Commit.

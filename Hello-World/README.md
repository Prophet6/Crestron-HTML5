...
First project in the [Crestron-HTML5](https://github.com/Prophet6/Crestron-HTML5) catalog. A custom **CH5** user interface **outside Construct** and outside the official shell template.
...
The previous archive name was `crestron-html5`; that URL may still be on the RMC4 until this project is deployed as `hello-world.ch5z`.
...
npm run build:ch5z       # dist/ + archive/hello-world.ch5z
